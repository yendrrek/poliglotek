...
public class ExcludedFromGoogleCustomSearch {
    ...
    static {
        ECOMMERCE_TERMS.put("af", "koop, aankoop, winkel, stoor, ooreenkoms, laaste kans, uitverkoping, afslag, promosie, " +
                "aanbod, aflewering, terugsendings, mandjie, betaling");
        ECOMMERCE_TERMS.put("sq", "blej, blerje, dyqan, magazinë, marrëveshje, shansi i fundit, shitje, zbritje, promovim, " +
                "ofertë, transport, kthime, shportë, pagesë");
        ECOMMERCE_TERMS.put("am", "ግዢ, ግዛት, ሱቅ, መደብር, እንቅስቃሴ, መጨረሻ እድል, ሽያጭ, ቅናሽ, እንቅስቃሴ, ቅርብ እንቅስቃሴ, መልስ, መልስቶች, " +
                "መርገጫ, ክፍያ");
        ECOMMERCE_TERMS.put("ar", "شراء, شراء, متجر, متجر, صفقة, الفرصة الأخيرة, تخفيضات, خصم, ترويج, عرض, شحن, إرجاع, سلة," +
                " دفع");
        ECOMMERCE_TERMS.put("hy", "գնել, գնում, խանութ, պահեստ, գործարք, վերջին հնարավորություն, վաճառք, զեղչ, արշավ, " +
        ...
        ECOMMERCE_TERMS.put("ay", "alisa, alita, tienda, almákën, oferta, quqicha, ichiniqa, ñayratiña, phunchalasiña, " +
        ...
        ECOMMERCE_TERMS.put("bm", "sanan, sanan, fɔnɔ, da, forokoyi, dɔ̀gɔfɛ̀ɛra, jawula, dɔgɔkolo, nyɔn sɛbɛnni, san, " +
        ...
        ECOMMERCE_TERMS.put("be", "купля, купля, крама, склад, здзелка, апошні шанец, распродаж, скідка, прасоўванне, " +
        ...
        ECOMMERCE_TERMS.put("en", "buy, purchase, shop, store, deal, last chance, sale, discount, promo, offer, shipping, " +
                "returns, cart, basket, payment");
        ECOMMERCE_TERMS.put("et", "osta, ost, pood, ladu, tehing, viimane võimalus, müük, allahindlus, reklaam, pakkumine, " +
        ...
        ECOMMERCE_TERMS.put("ka", "ყიდვა, შესყიდვა, მაღაზია, საწყობი, გარიგება, ბოლო შანსი, გაყიდვა, ფასდაკლება, " +
                "აქცია, შეთავაზება, მიტანა, დაბრუნება, კალათა, გადახდა");
        ECOMMERCE_TERMS.put("de", "kaufen, kauf, laden, lager, abkommen, letzte chance, verkauf, rabatt, werbung, angebot, " +
        ...
        ECOMMERCE_TERMS.put("ha", "saya, saya, shago, ma’ajin kaya, yarjejeniyar, damar ƙarshe, siyarwa, ragi, talla, " +
        ...
        ECOMMERCE_TERMS.put("ilo", "gatang, gatang, talipapa, tabiat, tulin, sakbay, gataan, tapan, patak, pauknangan, " +
                "taro, sakbayen, kalupi, kaba");
        ECOMMERCE_TERMS.put("id", "beli, pembelian, toko, gudang, kesepakatan, kesempatan terakhir, penjualan, diskon, " +
        ...
        ECOMMERCE_TERMS.put("it", "comprare, acquisto, negozio, magazzino, affare, ultima occasione, vendita, sconto, " +
                "promozione, offerta, spedizione, resi, cesta, pagamento");
        ECOMMERCE_TERMS.put("ja", "購入, 購入, 店舗, 倉庫, 取引, 最後のチャンス, 販売, 割引, プロモーション, オファー, " +
                "配送, 返品, かご, 支払い");
        ECOMMERCE_TERMS.put("jv", "tuku, tuku, toko, gudang, persetujuan, kesempatan pungkasan, adol, diskon, promosi, " +
        ...
        ECOMMERCE_TERMS.put("km", "ទិញ, ទិញ, ហាង, ឃ្លាំង, កិច្ចព្រមព្រៀង, ឱកាសចុងក្រោយ, លក់, បញ្ចុះតម្លៃ, ការផ្សព្វផ្សាយ, ការផ្ដល់ជូន, ការដឹកជញ្ជូន, " +
                "ត្រលប់វិញ, កន្ត្រក, ការទូទាត់");
        ECOMMERCE_TERMS.put("rw", "kugura, kugura, iduka, ububiko, amasezerano, amahirwe ya nyuma, kugurisha, kugabanya, " +
        ...
        ECOMMERCE_TERMS.put("gom", "खरेदी, खरेदी, दुकान, गोदाम, सौदा, शेवटचा चान्स, विक्री, सूट, प्रमोशन, ऑफर, शिपिंग, परत," +
                " बास्केट, पेमेंट");
        ECOMMERCE_TERMS.put("ko", "구매, 구매, 상점, 저장소, 거래, 마지막 기회, 판매, 할인, 프로모션, 제안, 배송, 반품, 장바구니, 결제");
        ECOMMERCE_TERMS.put("kri", "buy, store, deal, last chansu, sale, discount, promotion, offa, shipping, return, " +
                "basket, payment");
        ECOMMERCE_TERMS.put("ku", "kirîn, kirîn, firoke, magaza, peyman, careya paşîn, firotin, têgitandin, pêşvebirin, " +
        ...
        ECOMMERCE_TERMS.put("lt", "pirkti, pirkti, parduotuvė, sandėlis, sandoris, paskutinė galimybė, išpardavimas, " +
                "nuolaida, skatinimas, pasiūlymas, pristatymas, grąžinimas, krepšelis, mokėjimas");
        ECOMMERCE_TERMS.put("lg", "okugula, okugula, dduuka, omukutu, endagaano, omukisa ogusembayo, okutunda, ekisale, " +
                "ekigattiriza, ekiteeso, okutwala, okudda, ekibbo, okusasula");
        ECOMMERCE_TERMS.put("lb", "kafen, Akaf, Buttek, Lager, Deal, lescht Chance, Verkaaf, Remise, Promotioun, Offer, " +
        ...
        ECOMMERCE_TERMS.put("mt", "xiri, xiri, ħanut, maħżen, ftehim, l-aħħar ċans, bejgħ, skont, promozzjoni, offerta, " +
        ...
        ECOMMERCE_TERMS.put("lus", "lei, lei, bial, i te hlom, deal, hun hlui, hla rual, discount, promotion, huatruan, " +
                "thawk, luhkhawm, basket, payment");
        ECOMMERCE_TERMS.put("mn", "худалдаж авах, худалдан авалт, дэлгүүр, агуулах, хэлэлцээр, сүүлийн боломж, худалдаа, " +
        ...
        ECOMMERCE_TERMS.put("ny", "kugula, kugula, sitolo, zosungira, mgwirizano, mwayi womaliza, kugulitsa, kuchotsera, " +
                "kutsatsa, mwayi, kutumiza, kubweza, basket, malipiro");
        ECOMMERCE_TERMS.put("or", "କିଣ, କିଣ, ଦୋକାନ, ସ୍ତୋର, ବ୍ୟବସ୍ଥା, ଶେଷ ଅବସର, ବିକ୍ରୟ, ରିହାତି, ପ୍ରୋମୋଶନ୍, ପ୍ରସ୍ତାବ, ଶିପ୍ପିଙ୍ଗ, ପ୍ରତିଯୋଗୀତା, " +
                "ଟୋକରୀ, ପେମେଣ୍ଟ୍");
        ...
        ECOMMERCE_TERMS.put("fa", "خرید, خرید, فروشگاه, انبار, معامله, فرصت آخر, فروش, تخفیف, ترفیع, پیشنهاد, ارسال, بازگشت, سبد, پرداخت");
        ...
        ECOMMERCE_TERMS.put("nl", "kopen, aankopen, winkel, magazijn, deal, laatste kans, verkoop, korting, promotie, " +
        ...
        ECOMMERCE_TERMS.put("sr", "куповина, куповина, продавница, складиште, уговор, последња шанса, продаја, попуст, " +
                "промоција, понуда, достава, повратак, корпа, плаћање");
        ECOMMERCE_TERMS.put("st", "reka, reka, lebenkele, polokelo, tumellano, monyetla wa ho qetela, thekiso, theolelo, " +
                "papatso, nyehelo, thomello, khutlisetso, basket, tefo");
        ECOMMERCE_TERMS.put("sn", "kutenga, kutenga, chitoro, imba yekuchengetera, chibvumirano, mukana wekupedzisira, " +
                "kutengesa, dhisikaundi, kusimudzira, kupa, kutumira, kudzoka, basket, kubhadhara");
        ECOMMERCE_TERMS.put("sd", "خريد, خريد, دڪان, گودام, سودا, آخري موقعو, وڪرو, رعايت, مشهوري, پيشڪش, شپنگ, واپسي, ٽوڪري, ادائيگي");
        ...
        ECOMMERCE_TERMS.put("ti", "ግዢ, ግዢ, ሱቅ, እንደማ, ውል, አብራር አይነት, ሽያጭ, ቅናሽ, ዘማሪት, አቀማመጥ, መላክ, መመለስ, መክን, ክፍያ");
        ECOMMERCE_TERMS.put("ts", "xava, xava, xivandla, layeni, ntwanano, nkarhi wo hetelela, bindzu, hungula, nhundzu, " +
                "nyiko, ku rhumela, vuyela, basket, hakelo");
        ECOMMERCE_TERMS.put("tr", "satın al, satın alma, mağaza, depo, anlaşma, son şans, satış, indirim, promosyon, " +
        ...
        ECOMMERCE_TERMS.put("ak", "tɔ, tɔ, duka, faakyeɛ, apam, ɔpɛ daakye, adwuma, ntama, nkɔmbɔ, nsɛm a wɔde gu ho, " +
                "ɔbra mu nhyehyɛ, san ba, akotokuo, sika");
        ECOMMERCE_TERMS.put("uk", "покупка, купівля, магазин, склад, угода, останній шанс, розпродаж, знижка, просування, " +
        ...
        ECOMMERCE_TERMS.put("cy", "prynu, prynu, siop, warws, cytundeb, cyfle olaf, gwerthiant, gostyngiad, hyrwyddo, " +
                "cynnig, cludo, dychwelyd, basged, talu");
        ECOMMERCE_TERMS.put("xh", "thenga, thenga, ivenkile, indawo yokugcina impahla, isivumelwano, ithuba lokugqibela, " +
        ...
        ECOMMERCE_TERMS.put("yo", "rà, rà, ile itaja, ile ipamọ, adehun, àyànmọ́ ìkẹ́yìn, tita, ìdinkù, ìpolówó, ìpèsè, " +
                "gbigbe, ipadà, àpò, sisan");
        ECOMMERCE_TERMS.put("zu", "ukuthenga, ukuthenga, isitolo, isitoreji, isivumelwano, ithuba lokugcina, ukuthengisa, " +
        ...
        ECOMMERCE_TERMS.put("nso", "reka, reka, lebenkele, polokelo, tumellano, monyetla wa ho qetela, thekiso, theolelo, " +
                "papatso, nyehelo, thomello, khutlisetso, basket, tefo");
    }
}
