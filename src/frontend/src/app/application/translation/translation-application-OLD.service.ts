...
import { TranslationDomainServiceOLD } from '../../domain/translation/translation-domain.service-OLD';
...
export class TranslationApplicationOLDService {

  constructor(private translationDomainService: TranslationDomainServiceOLD,
